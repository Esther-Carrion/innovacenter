...
$all_mb_plugin = null;
if (!function_exists("mb_ideas_menu")) {
  add_action('admin_menu', 'mb_ideas_menu');
  $menu = wp_get_nav_menu_object("mb.ideas");
  function mb_ideas_menu()
  {
    global $menu;
  ...
  if (!function_exists("mb_list_all_plugin")) {
    function mb_list_all_plugin()
    {
      ...
      ?>
      <div class="wrap">
      <a href="https://pupunzi.com"><img style=" width: 350px" src="<?php echo plugins_url('images/logo.png', dirname(__FILE__)); ?>" alt="Made by Pupunzi"/></a>
